...
#ifndef INC_2016_12_15_STRINGS_CONTEST_STRING_CLASS_H
#define INC_2016_12_15_STRINGS_CONTEST_STRING_CLASS_H
//
// Created by ulyanin on 15.12.16.
//
...
//        cin >> l1 >> r1 >> l2 >> r2;
        --l1, --l2;
        cout << (str.get_hash(l1, r1) == str.get_hash(l2, r2) ? "Yes" : "No") << endl;
    }
    return 0;
}
#endif //INC_2016_12_15_STRINGS_CONTEST_STRING_CLASS_H
